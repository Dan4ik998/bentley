...
let mainscreenLabel = document.querySelector(".mainscreen__label");
...
if (iconMenu) {
	iconMenu.addEventListener("click", function () {
		...
		mainscreenLabel.classList.toggle("active");
		headerLogo.classList.toggle("active");
	});
}
//=================================================================================================================================================================
let suptitleItems = document.querySelector(".items-model__suptile");
suptitleItems.addEventListener("click", function (e) {
		let modelWindow = document.querySelector(".window-model");
		modelWindow.classList.toggle("active");
	});

document.documentElement.addEventListener("click", function (e) {
	if(!e.target.closest(".suptile-one")) {
		let modelWindow = document.querySelector(".window-model");
		modelWindow.classList.remove("active");
	}
});
//=================================================================================================================================================================
let supSecond = document.querySelector(".suptile-second");
supSecond.addEventListener("click", function (e) {
		let modelSecond = document.querySelector(".window-second");
		modelSecond.classList.toggle("active");
	});
document.documentElement.addEventListener("click", function (e) {
	if(!e.target.closest(".suptile-two")) {
		let modelSecond = document.querySelector(".window-second");
		modelSecond.classList.remove("active");
	}
});
//=================================================================================================================================================================
let supThird = document.querySelector(".suptile-third");
supThird.addEventListener("click", function (e) {
		let modelThird = document.querySelector(".window-third");
		modelThird.classList.toggle("active");
	});
document.documentElement.addEventListener("click", function (e) {
	if(!e.target.closest(".suptile-three")) {
		let modelThird = document.querySelector(".window-third");
		modelThird.classList.remove("active");
	}
});
//=================================================================================================================================================================
let supFourth = document.querySelector(".suptile-fourth");
supFourth.addEventListener("click", function (e) {
		let modelFourth = document.querySelector(".window-fourth");
		modelFourth.classList.toggle("active");
	});
document.documentElement.addEventListener("click", function (e) {
	if(!e.target.closest(".suptile-four")) {
		let modelFourth = document.querySelector(".window-fourth");
		modelFourth.classList.remove("active");
	}
});
//=================================================================================================================================================================
...
let img = $(".header__logo, .header__text"); // Наша картинка

$(window).scroll(function() {
	let winScroll = $(this).scrollTop(); // На сколько проскроллили сраницу (число)

	if (winScroll > 1000) { // Если проскроллили меньше 1000px от начала страницы
		$(img).addClass('lagas'); // Добавляем класс "black"
	}
	else { // Иначе
		$(img).removeClass('lagas'); // Удаляем класс "black"
	}
});
